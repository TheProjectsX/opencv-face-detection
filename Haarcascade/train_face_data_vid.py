...
# Using 2 cascades for Better Recognition.
# - FrontFaceCascade - Can Detect front Face Clearly
# - ProfileFaceCascade - Can be helpful to detect Side Face
...
def detectFace(image):
    faces = FrontFaceCascade.detectMultiScale(image, 1.3, 5)
    if (len(faces) == 0):
        faces = ProfileFaceCascade.detectMultiScale(image, 1.3, 5)
